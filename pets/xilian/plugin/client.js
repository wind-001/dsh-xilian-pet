function PetView({ ctx }) {
  ...
  return React.createElement('div', { className: 'xl-pet-layer' + (switchOn ? ' xl-pet-switch' : ''), style: layerStyle },
    panelOpen && React.createElement('div', { className: 'xl-pet-panel' },
      React.createElement('div', { className: 'xl-pet-badge xl-pet-badge-center', onClick: onBadgeClick }, name + ' ✦'),
    ...
    !panelOpen && React.createElement('div', { className: 'xl-pet-badge', onClick: onBadgeClick }, name + ' ✦'),
